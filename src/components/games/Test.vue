        ...
        <v-layout row wrap>
                            ...
                            <div>
                                <v-layout column>
                                    <v-flex xs12 md10 offset-md1>
                                        <v-progress-linear class="ml-2 mt-5" v-model="progressBar"></v-progress-linear>
                                    </v-flex>
                                </v-layout>
            ...
            <v-flex xs12 md6 lg4>
                <div style="position:relative; width:100%; height:100%; min-height:600px;">
                    <div style="position: absolute; left:2%; top:2%; width:96%; height:96%; background-repeat: no-repeat; background-size: contain " :style="{backgroundImage:`url('${items.image}')`}">
                        <!--<img v-if="items.image" :src="items.image" alt="">-->
                    </div>
                </div>
            </v-flex>
        </v-layout>
